                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="width-16-rem text-left">
                                <a href="{{ route('admin.market.comment.show', ['comment' => 1]) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> نمایش</a>
                        ...
                        <tr>
                            ...
                            <td>تایید شده</td>
                            <td class="width-16-rem text-left">
                                <a href="{{ route('admin.market.comment.show', ['comment' => 2]) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> نمایش</a>
