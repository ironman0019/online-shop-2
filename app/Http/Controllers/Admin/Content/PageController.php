...
class PageController extends Controller
{
    ...
    public function store(PageRequest $request)
    {
        ...
        return to_route('admin.content.page.index')->with('swal-success', ' پیج با موفقیت ایجاد شد');
    }
    ...
    public function update(PageRequest $request, Page $page)
    {
        ...
        return to_route('admin.content.page.index')->with('swal-success', 'پیج با موفقیت آپدیت شد');
    }
    ...
    {
        $page->delete();
        return to_route('admin.content.page.index')->with('swal-success', 'پیج با موفقیت حذف شد');
    }
